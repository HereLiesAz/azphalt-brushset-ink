# azphalt-brush-ink-and-marker

Brush packages for the "ink-and-marker" collection, each in its own `brushes/<slug>/` folder (manifest.json + LICENSE + assets/tip.png):

- `brushes/chisel-marker/` — **Chisel Marker** — A flat chisel-tip marker. Rotate with the angle param for thick-to-thin strokes.
